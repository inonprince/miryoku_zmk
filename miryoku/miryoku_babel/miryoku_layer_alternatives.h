...
U_MT(LCTRL, Q),    U_MT(LALT, S),     U_MT(LGUI, D),     U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(RSHFT, J),    U_MT(RGUI, K),     U_MT(RALT, L),     U_MT(RCTRL, M),    \
...
U_MT(LCTRL, Y),    U_MT(LALT, I),     U_MT(LGUI, E),     U_MT(LSHFT, A),    &kp DOT,           &kp D,             U_MT(RSHFT, S),    U_MT(RGUI, T),     U_MT(RALT, N),     U_MT(RCTRL, B),    \
...
U_MT(LCTRL, A),    U_MT(LALT, R),     U_MT(LGUI, S),     U_MT(LSHFT, T),    &kp D,             &kp H,             U_MT(RSHFT, N),    U_MT(RGUI, E),     U_MT(RALT, I),     U_MT(RCTRL, O),    \
...
U_MT(LCTRL, A),    U_MT(LALT, R),     U_MT(LGUI, S),     U_MT(LSHFT, T),    &kp G,             &kp M,             U_MT(RSHFT, N),    U_MT(RGUI, E),     U_MT(RALT, I),     U_MT(RCTRL, O),    \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LCTRL, A),    U_MT(LALT, R),     U_MT(LGUI, S),     U_MT(LSHFT, T),    &kp G,             &kp K,             U_MT(RSHFT, N),    U_MT(RGUI, E),     U_MT(RALT, I),     U_MT(RCTRL, O),    \
...
U_MT(LCTRL, A),    U_MT(LALT, O),     U_MT(LGUI, E),     U_MT(LSHFT, U),    &kp I,             &kp D,             U_MT(RSHFT, H),    U_MT(RGUI, T),     U_MT(RALT, N),     U_MT(RCTRL, S),    \
...
U_MT(LCTRL, S),    U_MT(LALT, H),     U_MT(LGUI, N),     U_MT(LSHFT, T),    &kp COMMA,         &kp DOT,           U_MT(RSHFT, A),    U_MT(RGUI, E),     U_MT(RALT, O),     U_MT(RCTRL, I),    \
...
U_MT(LCTRL, A),    U_MT(LALT, S),     U_MT(LGUI, H),     U_MT(LSHFT, T),    &kp G,             &kp Y,             U_MT(RSHFT, N),    U_MT(RGUI, E),     U_MT(RALT, O),     U_MT(RCTRL, I),    \
...
&kp PG_DN,         &kp LEFT,          &kp DOWN,          &kp RIGHT,         &u_caps_word,      U_NA,              &kp RSHFT,         &kp RGUI,          &kp RALT,          &kp RCTRL,         \
...
&kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      U_NA,              &kp RSHFT,         &kp RGUI,          &kp RALT,          &kp RCTRL,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              &kp DEL,           &kp BSPC,          &kp RET,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              U_NA,              &kp RSHFT,         &kp RGUI,          &kp RALT,          &kp RCTRL,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              &u_to_U_MOUSE,     &u_to_U_SYM,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_BTN3,            U_BTN1,            U_BTN2,            U_NA,              U_NA,              U_NA,              U_NP,              U_NP
...
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         U_NA,              &kp RSHFT,         &kp RGUI,          &kp RALT,          &kp RCTRL,         \
...
&kp COLON,         &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              &kp RSHFT,         &kp RGUI,          &kp RALT,          &kp RCTRL,         \
...
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,          U_NA,              &kp RSHFT,         &kp RGUI,          &kp RALT,          &kp RCTRL,         \
